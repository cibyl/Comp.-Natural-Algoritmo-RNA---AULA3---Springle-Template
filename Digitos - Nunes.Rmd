...
Modelo
```{r}
modelo <- h2o.deeplearning(x = colnames(treino[,1:120]),  y = "label",  training_frame = treino,  validation_frame = teste,  distribution = "AUTO",  activation = "RectifierWithDropout",  hidden = c(10),  sparse = TRUE, epochs = 20)
plot(modelo)
